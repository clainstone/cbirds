...
char new_output_buf[BIRDS_NUM * 150];
		      ...
		      char *output_buf, pthread_mutex_t *mutex)
{
	...
	sprintf(buf, "\033[%d;%dH\033_Ga=p,I=%d,q=2,p=%d,X=%d,Y=%d,z=%d\033\\", row, col, id + 1, 0,
		offset_x, offset_y, bird_no);
